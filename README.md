...
Image shows the Customer/End-User experience in creating a ticket to submit to the help desk
...
#### Working the issues:
Working the "entire mobile online banking is down" ticket has a default priority of Normal, we are going to update it to Emergency since this issue is an business impacting event. Image below reflects the selection of changing the priority and adding a note: 
...
Images below reflects the updates that have occurred in the ticket along with the re-assignments of the ticket. The open ticket "Ticket #756285" has been assigned to "Jane Doe" that was previously unassigned to a member of support.  The ticket reflects that it has been transferred to the System Administrators Department, which was previously under the Support Department.
...
##### Resolution:
After connecting with the Sys Admin team, we received a response letting us know that the ticket has been resolved and now reflects in the comments (pictured below). 
